...
The conventional fairness audit reports a $-5$ to $-7$ percentage-point V--VI vs.\ I--II accuracy gap across the four full-size generative respondents (Table~\ref{tab:prelim-fst-accuracy}). The IRT residualization, the LLTM nested decomposition, the saturated-item pruning robustness, the cross-backbone DINOv3 refit, the multi-seed sweep, the $\lambda_b$ prior-strength sweep, and the configural-invariance check are mutually consistent: after partialling out the lesion-category distribution and image-property covariates, the residual FST contribution is statistically indistinguishable from zero in either direction. The point estimate $\hat\Delta = -0.031$ logits with $95\%$ CI $[-0.271, +0.275]$ excludes any V--VI vs.\ I--II item-difficulty shift larger than about $0.28$ logits.
